...
Rules:
- All comps given are SOLD/off-market sales. A comp's "price" is the deed-recorded closing price when priceSrc="sold". When priceSrc="list" it is the final LIST price, which in competitive markets often sits a few percent BELOW what the house actually closed for — weigh those slightly upward, and prefer deed-priced comps when both are available. Judge each: does its price reflect a renovated/updated house comparable to the post-renovation subject? Prefer recent, close, similar-size RENOVATED sales (higher $/sf usually signals updated condition; low $/sf outliers are usually as-is/distressed — skip them).
